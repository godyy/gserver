...
// func (t *ScheduledTask) HeapLess(element heap.Element) bool {
// 	tt := element.(*ScheduledTask)
// 	return t.scheduledTime < tt.scheduledTime
// }

// func (t *ScheduledTask) SetHeapIndex(i int) {
// 	t.index = i
// }

// func (t *ScheduledTask) HeapIndex() int {
// 	return t.index
// }
...
// 	}
// 	isTop := t.HeapIndex() == 0
// 	tm.taskHeap.Remove(t.HeapIndex())
