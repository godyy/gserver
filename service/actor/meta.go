...
// 		if err = s.cluster.GetNode(meta.Deploy.Value, &ni); err != nil {
// 			return pkg_errors.WithMessage(err, "deploy on node: get node info")
// 		}
// 		meta.NodeId = meta.Deploy.Value
...
// 		}
// 		meta.NodeId = otherMeta.NodeId
// 		if _, err = s.md.UpdateMeta(meta); err != nil {
// 			return err
// 		}

// 	case DeployModeRecommend:
// 		if _, err = s.md.DeployRecommend(meta); err != nil {
// 			return err
// 		}
// 	}
...
// 	return s.cluster.GetNode(nodeId, ni)
// }
