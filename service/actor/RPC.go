...
// func (rc *rpcCall) HeapLess(o heap.Element) bool {
// 	return rc.expiredAt() < o.(*rpcCall).expiredAt()
// }

// func (rc *rpcCall) SetHeapIndex(i int) {
// 	rc.index = i
// }

// func (rc *rpcCall) HeapIndex() int {
// 	return rc.index
// }
