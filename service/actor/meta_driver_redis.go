...
// func (md *RedisMetaDriver) DeployRecommend(meta *Meta) (ok bool, err error) {
// 	// todo 选择推荐节点
// 	recommendNodeList := ""
// 	ret, err := md.redisCli.ZRevRangeWithScores(context.TODO(), recommendNodeList, 0, 10-1).Result()
// 	if err != nil {
// 		return false, err
// 	}

// 	if len(ret) == 0 {
// 		return false, fmt.Errorf("no node of category %s", meta.Deploy.Value)
// 	}
...
// 		w -= int64(v.Score)
// 		if w < 0 {
// 			meta.NodeId = v.Member.(string)
// 			break
// 		}
// 	}

// 	return md.UpdateMeta(meta)
// }
